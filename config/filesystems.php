...
return [
    ...
    */
    ...
    | configurado para cada controlador como un ejemplo de los valores requeridos.
    |
    ...
    */
    ...
    | Se ejecuta el comando `storage:link` de Artisan. Las claves de la matriz deben ser
